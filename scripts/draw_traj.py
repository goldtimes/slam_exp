...
filepath = "/home/kilox/kilox_ws/vio"
...
timestamp = []
tx_index = 5
position = np.loadtxt(filepath + '/imu_data.txt', usecols = (tx_index, tx_index + 1, tx_index + 2))

# imu_pose   imu_spline
position1 = []
quaterntions1 = []
timestamp1 = []
data = np.loadtxt(filepath + '/imu_traj.txt')
# timestamp1 = data[:,0]
...
quaterntions2 = []
timestamp2 = []
data = np.loadtxt(filepath + '/imu_traj_noise.txt')
# timestamp2 = data[:,0]
